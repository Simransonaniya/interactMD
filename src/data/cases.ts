...
export const CLINICAL_CASES: ClinicalCase[] = [
  {
    ...
    investigations: [
      ...
      },
      {
        ...
        isAbnormal: false,
        findingsDetail: ['Renal function preserved (eGFR > 60 mL/min/1.73m²), safe for urgent coronary angiographic contrast.']
      },
      {
        id: 'inv-ddimer',
        category: 'Laboratory',
        ...
        isAbnormal: false,
        findingsDetail: ['Normal D-Dimer lowers probability of massive/submassive pulmonary embolism.']
      }
    ],
    diagnosisOptions: [
      {
    ...
    facts: {
      ...
      associatedSymptoms: ['Profuse cold sweats (diaphoresis)', 'Mild lightheadedness', 'Nausea without vomiting', 'Shortness of breath'],
      pertinentNegatives: ['No sharp pleuritic pain with breathing', 'No sudden tearing pain between shoulder blades', 'No fever or chills', 'No calf swelling or recent long-distance travel'],
      pastMedicalHistory: ['Essential Hypertension diagnosed 6 years ago', 'Hyperlipidemia (elevated LDL)', 'No prior heart attack or stroke'],
      medications: ['Amlodipine 5 mg daily', 'Atorvastatin 20 mg daily (admits to missing doses frequently)'],
      allergies: ['No known drug allergies (NKDA)'],
      familyHistory: ['Father had a fatal myocardial infarction at age 52; Mother has type 2 diabetes.'],
      socialHistory: ['Smokes 0.5 packs per day for 25 years (12.5 pack-years)', 'Drinks 1-2 glasses of wine on weekends', 'Denies illicit drug use, including cocaine or amphetamines.'],
      reviewOfSystems: {
  ...
  },
  {
    ...
    facts: {
      ...
      associatedSymptoms: ['Complete loss of appetite (anorexia; "Could not even look at food")', 'Nausea with 1 episode of bilious emesis', 'Low-grade fever and mild chills'],
      pertinentNegatives: ['No diarrhea (last bowel movement normal yesterday morning)', 'No blood in stool', 'No dysuria, hematuria, or flank pain', 'No penile discharge or testicular pain'],
