...
interface NavbarProps {
  currentView: 'landing' | 'dashboard' | 'library' | 'simulation' | 'evaluation' | 'admin' | 'educator';
  setCurrentView: (view: 'landing' | 'dashboard' | 'library' | 'simulation' | 'evaluation' | 'admin' | 'educator') => void;
...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const handleNavClick = (view: 'landing' | 'dashboard' | 'library' | 'simulation' | 'evaluation' | 'admin' | 'educator') => {
    setCurrentView(view);
          ...
          <div className="pt-3 border-t border-[#39605B]/30 flex flex-col gap-2.5">
            <div className="flex items-center space-x-3 px-2">
              ...
              <div className="text-xs">
                <span className="font-bold text-[#F7F4EE] block">Sarah Jenkins, MS3</span>
                <span className="text-[10px] text-[#F7F4EE]/60">Johns Hopkins SOM</span>
              </div>
            </div>
